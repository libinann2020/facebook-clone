                        ...
                        <div class="flex md:flex-row flex-col gap-4 md:mt-6 -mt-16 items-center">
                            ...
                            <div class="md:mt-4 text-center md:text-left -mt-3">
                                ...
                                <div class="flex md:justify-start justify-center md:-ml-1">
                                    <img src="https://picsum.photos/id/141/300/300" class="rounded-full -ml-1 z-[10] w-[40px] h-[40px] border-white border-2">
                                    <img src="https://picsum.photos/id/142/300/300" class="rounded-full -ml-3 z-[9] w-[40px] h-[40px] border-white border-2">
                                    <img src="https://picsum.photos/id/143/300/300" class="rounded-full -ml-3 z-[8] w-[40px] h-[40px] border-white border-2">
                                    <img src="https://picsum.photos/id/144/300/300" class="rounded-full -ml-3 z-[7] w-[40px] h-[40px] border-white border-2">
                                    <img src="https://picsum.photos/id/145/300/300" class="rounded-full -ml-3 z-[6] w-[40px] h-[40px] border-white border-2">
                                    <img src="https://picsum.photos/id/146/300/300" class="rounded-full -ml-3 z-[5] w-[40px] h-[40px] border-white border-2">
                                    <img src="https://picsum.photos/id/147/300/300" class="rounded-full -ml-3 z-[4] w-[40px] h-[40px] border-white border-2">
                                </div>
                            </div>
                        </div>
